    ...
    <div class="content-container">
        <div class="container mt-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="text-center mb-0">Buy Max - Sell Max</h1>
                <div>
                ...
                <table id="DataTable" class="table table-bordered table-striped table-sm">
                    ...
                    @foreach($priceComparisons3 as $comparison)
                        <tr>
                            ...
                            <td>{{ number_format($comparison['city2_sell_price_max'], 2) }} $</td>
                            <td>{{ $comparison['profit'] }} $</td>
                            <td>{{ now()->diffInMinutes($comparison['city2_sell_price_max_date']) }}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
